...
export class FilmsComponent implements OnInit, OnDestroy {
  ...
  private mapFilms(rawFilms: Film[]): ViewFilm[] {
    return rawFilms.map(f => {
      ...
      return {
        ...f,
        safeUrl: this.sanitizer.bypassSecurityTrustResourceUrl(`https://www.youtube.com/embed/${id}?autoplay=1&mute=1&playsinline=1&rel=0&modestbranding=1&controls=1&showinfo=0&iv_load_policy=3&disablekb=1`),
